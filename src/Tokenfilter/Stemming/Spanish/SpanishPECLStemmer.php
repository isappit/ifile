<?php
namespace Isappit\Ifile\Tokenfilter\Stemming\Spanish;
 ...
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Spanish
...
/**
 * Lucene Token Filter per lo stemming della lingua Spagnola utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Spanish
...
class SpanishPECLStemmer implements TokenFilterInterface
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_spanish')) {
			throw new IFileStemException("Spanish Stemmer not supported. Install and compile PECL Stem with Spanish Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_spanish( $srcToken->getTermText() ),
