...
class StandardAnalyzer_Analysis_TokenFilter_TurkishPECLStemmer extends Zend_Search_Lucene_Analysis_TokenFilter
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_turkish')) {
			require_once dirname(__FILE__).'/../IFile_Stem_Exception.php';
			throw new IFile_Stem_Exception("Turkish Stemmer not supported. Install and compile PECL Stem with Turkish Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_turkish( $srcToken->getTermText() ),
