...
class StandardAnalyzer_Analysis_TokenFilter_SwedishPECLStemmer extends Zend_Search_Lucene_Analysis_TokenFilter
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_swedish')) {
			require_once dirname(__FILE__).'/../IFile_Stem_Exception.php';
			throw new IFile_Stem_Exception("Swedish Stemmer not supported. Install and compile PECL Stem with Swedish Stemmer.");
		}
    }
