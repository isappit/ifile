<?php
namespace Isappit\Ifile\Tokenfilter\Stemming\Swedish;
 ...
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Swedish
...
/**
 * Lucene Token Filter per lo stemming della lingua Svedese utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Swedish
...
class SwedishPECLStemmer implements TokenFilterInterface
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_swedish')) {
			throw new IFileStemException("Swedish Stemmer not supported. Install and compile PECL Stem with Swedish Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_swedish( $srcToken->getTermText() ),
