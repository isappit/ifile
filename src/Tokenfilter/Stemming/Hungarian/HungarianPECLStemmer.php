<?php
namespace Isappit\Ifile\Tokenfilter\Stemming\Hungarian;
 ...
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Hungarian
...
/**
 * Lucene Token Filter per lo stemming della lingua Ungherese utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Hungarian
...
class HungarianPECLStemmer implements TokenFilterInterface
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_hungarian')) {
			throw new IFileStemException("Hungarian Stemmer not supported. Install and compile PECL Stem with Hungarian Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_hungarian( $srcToken->getTermText() ),
