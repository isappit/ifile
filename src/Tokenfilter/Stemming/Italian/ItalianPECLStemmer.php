<?php
namespace Isappit\Ifile\Tokenfilter\Stemming\Italian;
 ...
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Italian
...
/**
 * Lucene Token Filter per lo stemming della lingua Italiana utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Italian
...
class ItalianPECLStemmer implements TokenFilterInterface
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_italian')) {
			throw new IFileStemException("Italian Stemmer not supported. Install and compile PECL Stem with Italian Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_italian( $srcToken->getTermText() ),
