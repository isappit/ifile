...
/**
 * Lucene Token Filter per lo stemming della lingua Porter utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/en-GB
...
class StandardAnalyzer_Analysis_TokenFilter_PorterPECLStemmer extends Zend_Search_Lucene_Analysis_TokenFilter
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_porter')) {
			require_once dirname(__FILE__).'/../IFile_Stem_Exception.php';
			throw new IFile_Stem_Exception("Porter Stemmer not supported. Install and compile PECL Stem with Porter Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_porter( $srcToken->getTermText() ),
