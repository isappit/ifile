<?php
namespace Isappit\Ifile\Tokenfilter\Stemming\Dutch;
 ...
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Dutch
...
/**
 * Lucene Token Filter per lo stemming della lingua Dutch utilizzando la libreria PECL "Stem" 
 * 
 * @category   IndexingFile
 * @package    ifile
 * @subpackage TokenFilter/Stemming/Dutch
...
class DutchPECLStemmer implements TokenFilterInterface
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_dutch')) {
			throw new IFileStemException("Dutch Stemmer not supported. Install and compile PECL Stem with Dutch Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_dutch( $srcToken->getTermText() ),
