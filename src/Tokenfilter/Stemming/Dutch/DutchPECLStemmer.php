...
class DutchPECLStemmer extends Zend_Search_Lucene_Analysis_TokenFilter
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_dutch')) {
			require_once dirname(__FILE__).'/../IFile_Stem_Exception.php';
			throw new IFile_Stem_Exception("Dutch Stemmer not supported. Install and compile PECL Stem with Dutch Stemmer.");
		}
    }
