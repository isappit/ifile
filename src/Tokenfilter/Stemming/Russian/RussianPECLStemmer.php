...
class StandardAnalyzer_Analysis_TokenFilter_RussianPECLStemmer extends Zend_Search_Lucene_Analysis_TokenFilter
{
    ...
    public function __construct(){
		...
		if (!function_exists('stem_russian')) {
			require_once dirname(__FILE__).'/../IFile_Stem_Exception.php';
			throw new IFile_Stem_Exception("Russian Stemmer not supported. Install and compile PECL Stem with Russian Stemmer.");
		}
    }
    ...
    public function normalize(Zend_Search_Lucene_Analysis_Token $srcToken) {
		...
		$newToken = new Zend_Search_Lucene_Analysis_Token(
                                     stem_russian( $srcToken->getTermText() ),
